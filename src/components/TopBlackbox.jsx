...
const TopBlackbox = ({ page, data }) => {
    ...
    return (
        <div className={`innertopbg ${page && `top${page}bg`}`}>
            {(page === "community" || page === "creators") && <Image src={(page === "community" && Images.communitytopbg) || (page === "creators" && Images.walletfootbg)} alt={data[0].heading ? data[0].heading : `${page}topbox`} className="img-fluid sectionbgimg" fill />}
            <Container>
